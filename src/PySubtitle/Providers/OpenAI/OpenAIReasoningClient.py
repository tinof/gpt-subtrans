    ...
    def _send_messages(self, messages: list[str], temperature):
        ...
        if result.usage:
            ...
            if completion_tokens_details:
                ...
                response["accepted_prediction_tokens"] = completion_tokens_details.accepted_prediction_tokens
                response["rejected_prediction_tokens"] = completion_tokens_details.rejected_prediction_tokens
