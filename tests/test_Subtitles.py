...
from PySubtitle.Helpers.Subtitles import FindSplitPoint, GetProportionalDuration, MergeSubtitles, MergeTranslations
...
class TestSubtitles(unittest.TestCase):
    ...
    merge_subtitles_cases = [
        ([example_line_1, example_line_2], SubtitleLine("1\n00:00:01,000 --> 00:00:03,500\nThis is line 1\nThis is line 2")),
        (
    ...
    merge_translation_cases = [
        ...
        ([example_line_1, example_line_2], [example_line_1, example_line_3], [example_line_1, example_line_2, example_line_3]),
        (
            [example_line_1, example_line_2],
            [alternative_line_1, example_line_3],
            [alternative_line_1, example_line_2, example_line_3],
        ),
        ([example_line_1, example_line_2], [alternative_line_1, alternative_line_2], [alternative_line_1, alternative_line_2]),
    ]
    ...
    def test_MergeTranslations(self):
        ...
        for group_1, group_2, expected in self.merge_translation_cases:
            with self.subTest(group_1=group_1, group_2=group_2):
                ...
                log_input_expected_result(f"Merged {len(group_1)} lines and {len(group_2)} lines", expected, merged_lines)
    ...
    split_point_cases = [
        ...
        (
            "7\n00:00:31,000 --> 00:00:35,000\nSeventh test subtitle.\nBreak after newline, not after the comma even if it is closer to the middle of the line.",
            "Seventh test subtitle.",
        ),
        (
            "8\n00:00:36,000 --> 00:00:40,000\nEighth test subtitle, break after second comma, because it is closer to the middle.",
            "Eighth test subtitle, break after second comma,",
        ),
        (
            "9\n00:00:36,000 --> 00:00:40,000\nNinth test subtitle. Break after the period, not the comma even if it is closer to the middle.",
            "Ninth test subtitle.",
        ),
        (
            "10\n00:00:41,000 --> 00:00:45,000\nTenth test subtitle, <i>We should not split here, even though there is a comma in the italic block.</i>",
            "Tenth test subtitle,",
        ),
        (
            "11\n00:00:46,000 --> 00:00:50,000\nEleventh test subtitle！Break after full-width exclamation mark.",
            "Eleventh test subtitle！",
        ),
        ("12\n00:00:51,000 --> 00:00:55,000\nTwelfth test subtitle.    Break after three spaces.", "Twelfth test subtitle."),
        (
            '13\n00:00:56,000 --> 00:01:00,000\n"Is this the 13th subtitle?" Break after the quote.',
            '"Is this the 13th subtitle?"',
        ),
        ('15\n00:01:06,000 --> 00:01:10,000\nThey say, "We should not! Split a quotation!"', "They say,"),
        (
            "16\n00:01:11,000 --> 00:01:15,000\nWe can split <i>a block in tags, if they do not match</b>",
            "We can split <i>a block in tags,",
        ),
        (
            "17\n00:01:16,000 --> 00:01:20,000\nWe shouldn't split the number 500,000 even if there is a comma in the middle.",
            "We shouldn't split the number 500,000 even if there is a comma in the middle.",
        ),
    ]
...
class SubtitleProcessorTests(unittest.TestCase):
    ...
    preprocess_cases = [
        ...
        (
            [example_line_6],
            {"max_line_duration": 3, "min_line_duration": 1.0},
            [
        ...
        (
            [example_line_9],
            {"remove_filler_words": True, "filler_words": standard_filler_words},
    ...
    postprocess_cases = [
        ...
        (
            [example_line_9],
            {
                ...
                "max_single_line_length": 30,
                "min_single_line_length": 10,
            },
