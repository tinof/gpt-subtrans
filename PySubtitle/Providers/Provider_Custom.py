        ...
        super().__init__(
            self.name,
            {
                "server_address": settings.get(
                    "server_address",
                    os.getenv("CUSTOM_SERVER_ADDRESS", "http://localhost:1234"),
                ),
                ...
                "supports_conversation": settings.get(
                    ...
                    GetEnvBool("CUSTOM_SUPPORTS_CONVERSATION", True),
                ),
                "supports_system_messages": settings.get(
                    "supports_system_messages",
                    GetEnvBool("CUSTOM_SUPPORTS_SYSTEM_MESSAGES", True),
                ),
                ...
                "max_completion_tokens": settings.get(
                    ...
                    GetEnvInteger("CUSTOM_MAX_COMPLETION_TOKENS", 0),
                ),
                ...
                "supports_parallel_threads": settings.get(
                    ...
                    GetEnvBool("CUSTOM_SUPPORTS_PARALLEL_THREADS", False),
                ),
            },
        )
